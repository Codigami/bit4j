package com.bit4j.facebook.entity.connection;
...
public class Inbox implements Serializable {
	...
	private List<com.bit4j.facebook.entity.Thread> data;
	private Paging paging;

	public List<com.bit4j.facebook.entity.Thread> getData() {
		return data;
	}

	public void setData(List<com.bit4j.facebook.entity.Thread> data) {
		this.data = data;
	}
